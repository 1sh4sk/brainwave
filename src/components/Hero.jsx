            ...
            <div ref={parallaxRef} className="container relative">
                <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb-[6rem]">
                    <h1 className="h1 mb-6">
                        ...
                        <span className="inline-block relative">Brainwave <img src={curve} className="absolute top-full left-0 wo-full xl:-mt-2 " width={624} height={28} alt="curve" /></span>
                    </h1>
                ...
                <div className="relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24">
                    ...
                    <div className="relative z-1 p-0.5 rounded-2xl bg-conic-gradient">
                        ...
                        <div className="relative bg-n-8 rounded-[1rem] ">
                            ...
                            <div className="aspect-[33/40]rounded-full overflow-hidden md:aspect-[699/490] lg:aspect-[1024/490]">
